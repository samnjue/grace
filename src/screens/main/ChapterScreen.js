...
const ChapterScreen = () => {
  ...
  const renderVerse = (verseText, verseKey) => {
    ...
    return (
      ...
      >
        <Text
          style={[styles.verse, isSelected && styles.selectedVerse]}
          maxFontSizeMultiplier={1.2}
        >
          <Text style={styles.verseNumber} maxFontSizeMultiplier={1.2}>
            {verseKey}{" "}
          </Text>
  ...
  return (
    ...
    >
      ...
      >
        <Text style={styles.chapterNumber} maxFontSizeMultiplier={1.2}>
          {chapter}
        </Text>
        {Object.keys(verses).map((verseKey) => (
          <View key={verseKey}>
            {headers[verseKey] && (
              <Text style={styles.header} maxFontSizeMultiplier={1.2}>
                {headers[verseKey]}
              </Text>
            )}
        ...
        >
          ...
          <View style={styles.panelContent}>
            <View style={{ flexDirection: "row", alignItems: "center" }}>
              ...
              />
              <Text
                style={styles.panelSectionTitle}
                maxFontSizeMultiplier={1.2}
              >
                Highlight
              </Text>
            ...
            <View style={styles.colorOptions}>
              ...
              {selectedVerses.some(
                (verse) => highlightedVerses[`${book}_${chapter}_${verse}`]
              ) && (
...
const getStyle = (theme) => {
  ...
  return {
    ...
    panel: {
      ...
      borderWidth: isDarkTheme ? 0.11 : 0.4,
      borderColor: "#d6d2d2",
      elevation: 10,
      padding: 15,
    },
